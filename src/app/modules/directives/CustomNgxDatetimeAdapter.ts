...
export class CustomNgxDatetimeAdapter extends NgxMatDateAdapter<Moment> {
    ...
    clone(date: Moment): Moment {
        return date.tz(CustomNgxDatetimeAdapter.TIMEZONE).clone().locale(this.locale);
    }
    ...
    createDate(year: number, month: number, date: number): Moment {
        ...
        const result = moment.tz(dateString, CustomNgxDatetimeAdapter.TIMEZONE);
    ...
    format(date: Moment, displayFormat: string): string {
        ...
        return date.tz(CustomNgxDatetimeAdapter.TIMEZONE).format(CustomNgxDatetimeAdapter.FORMAT ? CustomNgxDatetimeAdapter.FORMAT : displayFormat);
    }
    ...
    private _createMoment(
        ...
        return useUtc
            ? moment.utc(date, format, locale, strict).tz(CustomNgxDatetimeAdapter.TIMEZONE)
            : moment(date, format, locale, strict).tz(CustomNgxDatetimeAdapter.TIMEZONE);
    }
}